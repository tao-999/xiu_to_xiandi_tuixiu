      ...
      return Dialog(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildSection('资质31~40', ownedAptitudes, 31, 40),
              _buildSection('资质41~50', ownedAptitudes, 41, 50),
              _buildSection('资质51~60', ownedAptitudes, 51, 60),
              _buildSection('资质61~70', ownedAptitudes, 61, 70),
              _buildSection('资质71~80', ownedAptitudes, 71, 80),
              _buildSection('资质81~90', ownedAptitudes, 81, 90),
              _buildSection('资质91~100', ownedAptitudes, 91, 100),
            ],
          ),
        ),
      );
