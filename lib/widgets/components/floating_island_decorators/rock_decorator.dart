  ...
  Future<void> onLoad() async {
    ...
    add(
      FloatingIslandDynamicSpawnerComponent(
        ...
        dynamicSpritesMap: {
          'rock': [
            DynamicSpriteEntry('hell/diyu_1.png', 1, hp: 5000, atk: 150, def: 220, type: 'boss_2', enableAutoChase: true, autoChaseRange: 200, priority: 999),
            DynamicSpriteEntry('hell/diyu_2.png', 1, hp: 5000, atk: 150, def: 220, type: 'boss_2', enableAutoChase: true, autoChaseRange: 200, priority: 999),
            ...
            DynamicSpriteEntry('hell/diyu_4.png', 1, hp: 5000, atk: 150, def: 220, type: 'boss_2', enableAutoChase: true, autoChaseRange: 200, priority: 999),
            DynamicSpriteEntry('hell/diyu_5.png', 1, hp: 5000, atk: 150, def: 220, type: 'boss_2', enableAutoChase: true, autoChaseRange: 200, priority: 999),
            DynamicSpriteEntry('hell/diyu_6.png', 1, hp: 5000, atk: 150, def: 220, type: 'boss_2', enableAutoChase: true, autoChaseRange: 200, priority: 999),
            DynamicSpriteEntry('hell/diyu_7.png', 1, hp: 5000, atk: 150, def: 220, type: 'boss_2', enableAutoChase: true, autoChaseRange: 200, priority: 999),
            ...
            DynamicSpriteEntry('hell/diyu_14.png', 1, hp: 5000, atk: 150, def: 220, type: 'boss_2', enableAutoChase: true, autoChaseRange: 200, priority: 999),
            ...
            DynamicSpriteEntry('hell/diyu_18.png', 1, hp: 5000, atk: 150, def: 220, type: 'boss_2', enableAutoChase: true, autoChaseRange: 200, priority: 999),
          ],
        },
        dynamicTileSize: 184,
        seed: seed,
